...
public class RealEstateMapper {
	...
	public RealEstate toEntity(RealEstateCreateDTO createDto, User owner, List<String> imageUrls) {
		...
		// 🆕 CRITICAL: ADD ALL REQUIRED FIELDS FROM DTO
	...
	public RealEstateResponseDTO toResponseDto(RealEstate entity) {
		...
		dto.setFeaturedAt(entity.getFeaturedAt());
		dto.setFeaturedUntil(entity.getFeaturedUntil());
	...
	public void updateEntity(RealEstateUpdateDTO updateDto, RealEstate entity) {
		...
		if (updateDto.getPropertyType() != null)
			entity.setPropertyType(updateDto.getPropertyType());
		if (updateDto.getListingType() != null)
			entity.setListingType(updateDto.getListingType());
		...
		if (updateDto.getZipCode() != null)
			entity.setZipCode(updateDto.getZipCode());
		if (updateDto.getSizeInSqMt() != null)
			entity.setSizeInSqMt(updateDto.getSizeInSqMt());
		if (updateDto.getFeatures() != null)
			entity.setFeatures(updateDto.getFeatures());
		...
		if (updateDto.getFeaturedAt() != null)
			entity.setFeaturedAt(updateDto.getFeaturedAt());
		if (updateDto.getFeaturedUntil() != null)
			entity.setFeaturedUntil(updateDto.getFeaturedUntil());

		// UPDATE AGENT FIELDS:
		if (updateDto.getAgentName() != null)
			entity.setAgentName(updateDto.getAgentName());
		if (updateDto.getAgentPhone() != null)
			entity.setAgentPhone(updateDto.getAgentPhone());
		if (updateDto.getAgentLicense() != null)
			entity.setAgentLicense(updateDto.getAgentLicense());
		...
		if (updateDto.getRoomCount() != null)
			entity.setRoomCount(updateDto.getRoomCount());
		if (updateDto.getFloor() != null)
			entity.setFloor(updateDto.getFloor());
		if (updateDto.getTotalFloors() != null)
			entity.setTotalFloors(updateDto.getTotalFloors());
		if (updateDto.getConstructionYear() != null)
			entity.setConstructionYear(updateDto.getConstructionYear());
		if (updateDto.getMunicipality() != null)
			entity.setMunicipality(updateDto.getMunicipality());
		if (updateDto.getHeatingType() != null)
			entity.setHeatingType(updateDto.getHeatingType());
		if (updateDto.getPropertyCondition() != null)
			entity.setPropertyCondition(updateDto.getPropertyCondition());
	}
}